...
@section('contenido')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        <div class="md:w-6/12 p-5">
            <img src="{{ asset('https://www.elmueble.com/medio/2023/07/03/recetas-con-espinacas_88985321_230703094259_900x900.jpg') }}" alt="Imagen de login de usuarios" class="md:rounded-lg shadow-lg">
        </div>
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-lg">
            <form method="POST" action="{{ route('login') }}" novalidate>
                ...
                <input type="submit" value="Iniciar sesión" style="background-color: #555555;" class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg">
            </form>
        </div>
    </div>
@endsection